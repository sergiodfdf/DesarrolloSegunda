...
import prueba.modelo.EnviarCorreo;
...
public class insertarReply {
    ...
    @RequestMapping(value = "/insertarReply", method = RequestMethod.POST, consumes = "application/xml", produces="application/xml")
        
    	public @ResponseBody Comentario insertarComentarioInXML(@RequestBody Comentario entrada) {
            
                System.out.println("hola InsertarReply");
...
//                Usuario e = (Usuario) jaxb2Marshaller.unmarshal(source);
		...
		Comentario comment = new Comentario();
                ...
                System.out.println("Comentario: "+ entrada.getReply());
                ...
                if (entrada.getId().isEmpty()){
                   ...
                   entrada.setReply("ERROR 090");
                   logUtility.error("El campo token del objeto Comentario Reply se encuentra nulo");
                ...
                if (entrada.getFecha_creacion().isEmpty()){
                   ...
                   entrada.setReply("ERROR 009");
                   logUtility.error("El campo fecha del objeto Comentario Reply se encuentra nulo");
                   ...
                   entrada.setAdjunto("NO");
                    ...
                    if (entrada.getmensaje().isEmpty()){
                       ...
                       entrada.setReply("ERROR 010");
                       logUtility.error("El campo mensaje del objeto Comentario Reply se encuentra nulo");
                   return entrada;
               } 
                 else
                   ...
                   entrada.setReply("ERROR 011");
                   logUtility.error("El campo nickName del objeto Comentario se encuentra nulo");
                  
                   return entrada;
               }
                else
                    if (entrada.getReply().isEmpty()){
                        entrada.setId("ERROR 012");
                         entrada.setFecha_creacion("ERROR 012");
                   entrada.setAdjunto("ERROR 012");
                   entrada.setmensaje("ERROR 012");
                   entrada.setnickName("ERROR 012");
                   entrada.setReply("ERROR 012: Reply Nulo");
               ...
               existe = dao.findComentario(entrada.getReply());
...
//                            entrada.setReply("0");
                            ...
                            dao.insertarReplySuperColumn(entrada);
                            
                            Usuario buscar = new Usuario();
                            daoUser = new usuarioDAOImpl();
                            
                            buscar = daoUser.findUsuario(existe.getnickName());
                            
                            String correo = buscar.getCorreo();
                            String mensaje = entrada.getmensaje();
                            
                            EnviarCorreo mail = new EnviarCorreo();
                            
                            System.out.println("Enviando correo al usuario: "+correo);
                            
                            mail.enviarEmail("Reply de un comentario",mensaje,correo);
                            
                            logUtility.info("El comentario Reply= " + entrada.getId() + " se ha insertado exitosamente.");
                            ...
                            entrada.setReply("ERROR 150");
                            logUtility.error("El Token= " + findTokenViejo.getTokken() + " no corresponde con el usuario.");
                            ...
                            entrada.setReply("ERROR 111");
                            logUtility.error("El Token no existe en el sistema.");
                       
                            return entrada;
               }
               else{
                   
                            System.out.println("El comentario raiz no existe");
                            entrada.setId("ERROR 211");
                            entrada.setFecha_creacion("ERROR 211");
                            entrada.setAdjunto("ERROR 211");
                            entrada.setmensaje("ERROR 211");
                            entrada.setnickName("ERROR 211");
                            entrada.setReply("ERROR 211: El comentario raiz no existe");
                            logUtility.error("El comentario raiz asignado no existe.");

...
<div class="container">
      ...
      <div class="content">
        <div class="page-header">
          ...
          <h1><small>Ventana para la visualizacion de los comentarios del usuario</small></h1>
        </div>
        <div class="row">
          <div class="span10">
        ...
        <form action="<c:url value="comentariosDeUsuario"></c:url>" method="get" name="probando">
	<fieldset>
	<div id="comentariosEnLista">
		<table class="bordered-table">
		<tr><th>#</th><th>Contenido</th><!--<th>Fecha Creacion</th>--><th>Acciones</th></tr>
		<c:forEach items="${comentariosEnLista}" varStatus="status" var="comments">
			<tr>
				<td>${status.index}</td><td>${comments.mensaje}</td><!--<td>${comments.fecha_creacion}</td>-->
                                ...
                                <td><a class="btn danger" href="<c:url value="/borrandoComentario?messageee=${comments.id}"/>"><i class="papelera icon-white5"></i></a></td>
			</tr>
		</c:forEach>
		</table>
	</div>

...
<title>Reply de un comentario</title>
</head>
<body>
<div class="container">
	...
	<form action="<c:url value="replyDeUnComentario"></c:url>" method="post">
	<fieldset>
		  <div class="clearfix">
            ...
            <div class="input">
              <textarea id="etiquetas" name="etiquetas" rows="3" style="width: 400px;"></textarea>
            </div>
          </div>
          <div class="actions">
